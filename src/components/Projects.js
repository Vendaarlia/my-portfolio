...
function Projects() {
  return (
    <section id='project' className='text-gray-400 bg-gray-900 body-font'>
                ...
                {projects.map((project) => (
                    <a href={project.link} key={project.image} className='sm:w-1/2 w-100 p-4'>
                        <div className='flex relative'>
                            ...
                            <div className='px-8 py-10 relative z-10 w-full bg-black bg-opacity-80 border-4 border-gray-900 opacity-0 hover:opacity-100'>
